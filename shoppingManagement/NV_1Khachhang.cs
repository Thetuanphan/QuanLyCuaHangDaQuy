...
{
    public partial class NV_1Khachhang : Form
    {
        public NV_1Khachhang(string user, string pass)
        {
            InitializeComponent();
        ...
        private void tieptuc_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Hide();
                NV_2Mahoadon f3 = new NV_2Mahoadon(usertxt.TextName, passtxt.TextName, MaKH.TextName);
                f3.ShowDialog();
            }
        }
