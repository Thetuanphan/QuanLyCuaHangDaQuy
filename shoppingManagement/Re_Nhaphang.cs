...
{
    public partial class Re_Nhaphang : Form
    {
        public Re_Nhaphang()
        {
            InitializeComponent();
        ...
        private void lapbc_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                */
                ...
                string c = MaPH.TextName;

                nhaphang sr = new nhaphang();

                string sql = "Select * from chitietNSP " +
                    " where MaPH ='" + c + "'";
                ...
                adapter1.Fill(s1, "PHIEUNSP");
                DataTable dt = s1.Tables["PHIEUNSP"];
                sr.SetDataSource(s1.Tables["PHIEUNSP"]);
